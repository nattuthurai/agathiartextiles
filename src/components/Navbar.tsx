...
const Navbar = () => {
  ...
  const [isDropdownMenuHidden, setIsDropdownMenuHidden] = useState(false);
  ...
  const handleDropdownToggle = () => {
    ...
    setIsDropdownMenuHidden(!isDropdownMenuHidden);
  };
          ...
          <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            ...
            <li>
              ...
              <div
                id="dropdownNavbar"
                className={`${
                  isDropdownMenuHidden ? "hidden" : ""
                } absolute z-10 hidden font-normal bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600`}
              >
                <ul
